            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              <div className="space-y-6 lg:space-y-8 text-center lg:text-left">
                <div className="space-y-3 sm:space-y-4">
                  ...
                  <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-vt323 tracking-tight leading-tight">
                    {contentLoading ? (
                      'Loading...'
        ...
        <section className="py-12 sm:py-16 lg:py-20 bg-muted/30">
          <div className="container px-4 sm:px-6 lg:px-8">
            <div className="text-center space-y-3 sm:space-y-4 mb-12 sm:mb-16">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-vt323">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
              {features.map((feature, index) => (
                <Card key={index} className="p-4 sm:p-6 text-center hover:shadow-lg transition-shadow">
                  ...
                  <h3 className="text-lg sm:text-xl font-vt323 mb-2">{feature.title}</h3>
          ...
          <div className="container px-4 sm:px-6 lg:px-8">
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
              <Card className="p-4 sm:p-6">
                <h3 className="text-lg sm:text-xl font-vt323 mb-3">Income Rankings</h3>
              ...
              <Card className="p-4 sm:p-6">
                <h3 className="text-lg sm:text-xl font-vt323 mb-3">Portfolio Tracker</h3>
                <p className="text-sm sm:text-base text-muted-foreground mb-4 leading-relaxed">
              ...
              <Card className="p-4 sm:p-6 sm:col-span-2 lg:col-span-1">
                <h3 className="text-lg sm:text-xl font-vt323 mb-3">Market Alerts</h3>
                <p className="text-sm sm:text-base text-muted-foreground mb-4 leading-relaxed">
